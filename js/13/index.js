...
function initMap() {
    ...
    const infowindow1 = new google.maps.InfoWindow({
        content: `<div>
                    ...
                    <p>Заснований (початок зведення 24 червня 1599 р.) князем Янушем Заславським (бл. 1556 — 4.VIII.1629) і його дружиною княжною 
                    Олександрою Романівною Санґушківною († 1602) разом з будинками школи, шпиталю і плебанії для священиків, коштом міської оренди у Старому Заславі. 
                    На власність парафії передавалося село Збирів. Згідно з фундушем Януша Заславського при храмі повинні були утримуватися три священики. 
                    Будувався за проєктом швейцарського архітектора Якопо Мадлена у відповідності до ренесансної архітектурної традиції.
    ...
    const infowindow2 = new google.maps.InfoWindow({
        content: `<div>
                    ...
                    <p>Собор Різдва Христового — втрачена пам'ятка православного сакрального будівництва в Заславі на Волині. Збудована в другій чверті 19 століття 
                    на місці старої замкової церкви. Знищена комуністами в 1930-х роках.
                    Церкву Різдва Христового ПРЦ закладено на місці старої замкової церкви «на чотири дзвони». 
                    Будівництво, що розпочалося на пожертви доброчинців, завершено в 1835 році коштом власника міста, князя Карла Санґушка. 
                    У 1836 році церкву освячено. Храм мав два престоли: Різдва Христового і Преображення Господнього. Був це тинькований кам'яний однобаневий храм центричного типу, 
                    в проєкції латинського хреста, з добудованим від заходу притвором.
    ...
    const infowindow3 = new google.maps.InfoWindow({
        content: `<div>
                    ...
                    <p>Пала́ц кня́зів Санґу́шків — барокова будівля, частина архітектурного комплексу, розташованого на обширі Новозаславського замку 
                    (нині місто Ізяслав Хмельницької області), що ефектно розкинувся на мисі при впадінні річки Понори до річки Горині. Палац збудовано 
                    у 1754 —1770 роках для Барбари Санґушкової як приватна резиденція і урядовий центр волинських володінь князів Санґушків.
                    Сама будівля — двоповерховий будинок, що отримав ориґінальне планування piano nobile, і не подібний до інших палаців Речі Посполитої. 
                    Вплив особистого смаку Барбари Санґушкової є визначним у реалізації проєкту, її не задовольнив проєкт розроблений Паоло Фонтана: 
                    ...
                    Будівельні зусилля, здійснені під зверхністю князів Санґушків на новозаславському замковому обширі, були настільки змінили його образ, 
                    що й сам замок відтоді отримав нове ім'я — замок Санґушків, а й просто «палац».
    ...
    const infowindow4 = new google.maps.InfoWindow({
        content: `<div>
                    ...
                    Старозаславський замок — єдина частково збережена будівля замкового комплексу 15 століття, розташована на останці у
                     старій частині міста Ізяслава на Волині при впадінні річки Сошені до річки Горині.
                    Спорудження в XV столітті Старозаславського замку пов'язують з ім'ям князя Василя Федоровича Красного (*?—† після 1461).
                    На існування замку в означений час вказує й та обставина, що заславські замкові книги велися від 1512 року. Книги за 1572–1575 рр. 
                    досі є цінним джерелом з історії Заславської волості, до якої, крім міста Заслава, в другій половині XVI ст. входило ще 70 містечок і сіл.
    ...
    const infowindow5 = new google.maps.InfoWindow({
        content: `<div>
                    ...
                    <p>
                    Костел Святого Йосифа та монастир лазаристів (пол. Kościół św. Józefa Oblubieńca i klasztor oo. Misjonarzy) — 
                    комплекс колишнього монастиря католицького товариства лазаристів і костелу Святого Йосифа, що знаходиться по вул. 
                    Шевченка, 10 (колишній Старокостянтинівській) в Ізяславі. Це одна з найцікавіших пам'яток пізнього бароко на Волині. Костел є єдиною 
                    нині діючою католицькою культовою спорудою в місті, що використовується парафією Святого Йосифа. 
